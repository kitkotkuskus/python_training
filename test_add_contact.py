...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        wd.find_element_by_name("address").send_keys("Russia, Moscow, Green street 5")
        wd.find_element_by_name("home").click()
        wd.find_element_by_name("home").clear()
        wd.find_element_by_name("home").send_keys("564585")
        wd.find_element_by_name("mobile").click()
        wd.find_element_by_name("mobile").clear()
        wd.find_element_by_name("mobile").send_keys("89746521278")
        ...
        wd.find_element_by_name("homepage").send_keys("www.ivanov.ru")
