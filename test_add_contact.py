...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        driver.find_element_by_name("nickname").send_keys("IvAnOv")
        driver.find_element_by_name("photo").click()
        driver.find_element_by_name("title").click()
        driver.find_element_by_name("company").click()
        driver.find_element_by_name("company").clear()
        driver.find_element_by_name("company").send_keys("Three")
        ...
        driver.find_element_by_name("photo").send_keys("C:\\fakepath\\field_image_muholovka.jpg")
        driver.find_element_by_name("title").click()
        driver.find_element_by_name("title").clear()
        driver.find_element_by_name("title").send_keys("employee")
        driver.find_element_by_name("company").click()
        driver.find_element_by_name("company").clear()
        driver.find_element_by_name("company").send_keys("bank")
        driver.find_element_by_name("address").click()
        driver.find_element_by_name("address").clear()
        driver.find_element_by_name("address").send_keys("Russia, Moscow, Green street 5")
        driver.find_element_by_name("home").click()
        driver.find_element_by_name("home").clear()
        driver.find_element_by_name("home").send_keys("564585")
        driver.find_element_by_name("mobile").click()
        driver.find_element_by_name("mobile").clear()
        driver.find_element_by_name("mobile").send_keys("89746521278")
        driver.find_element_by_name("work").click()
        driver.find_element_by_name("work").clear()
        driver.find_element_by_name("work").send_keys("-")
        driver.find_element_by_name("fax").click()
        driver.find_element_by_name("fax").clear()
        driver.find_element_by_name("fax").send_keys("-")
        ...
        driver.find_element_by_name("homepage").send_keys("www.ivanov.ru")
        driver.find_element_by_name("bday").click()
        Select(driver.find_element_by_name("bday")).select_by_visible_text("21")
        driver.find_element_by_xpath("//option[@value='21']").click()
        ...
        Select(driver.find_element_by_name("aday")).select_by_visible_text("21")
        driver.find_element_by_xpath("//div[@id='content']/form/select[3]/option[23]").click()
        ...
        Select(driver.find_element_by_name("new_group")).select_by_visible_text("hfo")
        driver.find_element_by_xpath("//div[@id='content']/form/select[5]/option[18]").click()
